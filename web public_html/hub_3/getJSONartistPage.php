...
class Pdfs
{
    ...
    */
    public function select()
    {
        ...
        if($con != null)
        {
            $result=$con->query("SELECT * FROM songs WHERE artist='".$artId."' ");
...
*/
                    ...
                    array_push($pdfs, array("id"=>$row['id'],"title"=>$row['title'],"artist"=>$row['artist'],"album"=>$albn,"genre"=>$row['genre'],"duration"=>$row['duration'],"path"=>$row['path'],"albumOrder"=>$row['albumOrder'],"plays"=>$row['plays']));
                }
