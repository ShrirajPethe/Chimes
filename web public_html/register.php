...
<html>
<head>
	<title>Welcome to Wind Chimes!</title>
...
<!-- 						<div id="loginText">
 -->							<h2>Listen to loads of songs for free</h2>
							...
							<h1>Get
								<span
								class="txt-rotate"  id="spetxt"
								data-period="2000"
								data-rotate='[ "great music.", "peace of mind.", "calm.", "joy to your soul.", "some groove!", "melody for your life." ]'></span>
							</h1>
